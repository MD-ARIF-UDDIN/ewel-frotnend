...
const LoginAdmin = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (result.success) {
                ...
                if (result.user.role === 'HCS Admin') {
                    setSuccess('Login successful! Redirecting to HCS dashboard...');
                    setTimeout(() => navigate('/dashboard/hcs'), 1000);
                ...
                // Keep the error message displayed without any redirect
                setError(result.message || 'Login failed. Please try again.');
                // Ensure we don't navigate anywhere on failed login
                return;
            }
        } catch (error) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex items-center justify-center p-4 transition-colors duration-300 pt-20">
                ...
                <CardContent>
                    <form onSubmit={handleLogin} className="space-y-4">
                        ...
                        <div className="text-center">
                            <p className="text-sm text-gray-600 dark:text-slate-300">
                                Admin access only. Contact superadmin for account creation.
                            </p>
                        </div>
                    </form>
                    ...
                    <div className="mt-6 pt-6 border-t">
                        <div className="text-center space-y-2">
                            ...
                            <Link to="/login-superadmin" className="text-sm text-blue-600 dark:text-blue-400 hover:underline block">
                                Superadmin Login
                            </Link>
                        </div>
                    </div>
